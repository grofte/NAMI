...
71,,,water,,,,,
72,,,water,,,,,
73,5.3,0.0009,buffer B (w/ salt),100,Na2 malonate,800,,
74,7,-0.0086,buffer B (w/ salt),100,Na2 malonate,800,,
75,9.2,-0.0169,buffer B (w/ salt),100,Na2 malonate,800,,
76,5,0.0016,buffer B (w/ salt),100,Na2 malonate,400,,
77,6.9,-0.0089,buffer B (w/ salt),100,Na2 malonate,400,,
78,9.2,-0.0184,buffer B (w/ salt),100,Na2 malonate,400,,
79,5.3,0.0009,buffer B (w/ salt),100,NaCl,800,,
80,7.3,-0.0086,buffer B (w/ salt),100,NaCl,800,,
81,9.3,-0.0169,buffer B (w/ salt),100,NaCl,800,,
82,5.2,0.0016,buffer B (w/ salt),100,NaCl,400,,
83,7.1,-0.0089,buffer B (w/ salt),100,NaCl,400,,
84,9.2,-0.0184,buffer B (w/ salt),100,NaCl,400,,
85,4.9,0.0057,buffer C (w/ salt),100,Na2 malonate,800,,
86,6.7,-0.0119,buffer C (w/ salt),100,Na2 malonate,800,,
87,8.2,-0.0089,buffer C (w/ salt),100,Na2 malonate,800,,
88,5,0.0024,buffer C (w/ salt),100,Na2 malonate,400,,
89,6.7,-0.0136,buffer C (w/ salt),100,Na2 malonate,400,,
90,8.9,-0.0092,buffer C (w/ salt),100,Na2 malonate,400,,
91,5.3,0.0057,buffer C (w/ salt),100,NaCl,800,,
92,7,-0.0119,buffer C (w/ salt),100,NaCl,800,,
93,9.1,-0.0089,buffer C (w/ salt),100,NaCl,800,,
94,5,0.0024,buffer C (w/ salt),100,NaCl,400,,
95,6.9,-0.0136,buffer C (w/ salt),100,NaCl,400,,
96,9,-0.0092,buffer C (w/ salt),100,NaCl,400,,
